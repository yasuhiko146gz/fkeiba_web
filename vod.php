  ...
  <script type='text/javascript'>
    ...
    new FvPollingLib({
      ...
      updateRaceInfo: function(race_idx) {
        // <li><a id="ref-info" href="https://www.keiba.go.jp/KeibaWeb_IPAT/TodayRaceInfo/DebaTable_ipat?k_raceDate=2024%2f02%2f08&k_raceNo=1&k_babaCode=19">馬柱</a></li>
        // <li><a id="ref-odds" href="https://www.keiba.go.jp/KeibaWeb_IPAT/TodayRaceInfo/OddsTanFuku_ipat?k_raceDate=2024%2f02%2f07&k_raceNo=1&k_babaCode=19">オッズ</a></li>
        // <li><a id="ref-pred" href="https://nar.sp.netkeiba.com/?pid=funabashi_shutuba&race_id=202443020701">予想</a>
        //https://www.nankankeiba.com/uma_shosai/2024020919110501.do
        /* 240208 正常動作確認済 → 澤田さん回答で没
                race_idx_zeropad = race_idx.toString().padStart(2, '0');
                info_url = "https://www.nankankeiba.com/uma_shosai/20240209191105"+race_idx_zeropad+".do";
                $("#ref-info").attr("href",info_url);
                odds_url = "https://nar.netkeiba.com/odds/index.html?race_id=2024430209"+race_idx_zeropad;
                $("#ref-odds").attr("href",odds_url);
                pred_url = "https://nar.sp.netkeiba.com/?pid=funabashi_shutuba&race_id=2024430209"+race_idx_zeropad;
                $("#ref-pred").attr("href",pred_url);
                console.log("updateRaceInfo race_idx="+race_idx+" info="+info_url+" odds="+odds_url+" pred="+pred_url);
        */
      },
